$(function () {
  ...
  var search_types = [
    ...
    { url: 'https://fsoufsou.com/search?q=', type: 'fsou' },
    { url: 'https://so.toutiao.com/search?dvpf=pc&keyword=', type: 'toutiao' },
    { url: 'https://cn.bing.com/search?q=', type: 'bing' },
    { url: 'https://kaifa.baidu.com/searchPage?wd=', type: 'code' },
    { url: 'https://www.so.com/s?q=', type: 'soso' },
    { url: 'https://www.google.com/search?q=', type: 'google' },
    { url: 'https://github.com/search?q=', type: 'github' },
    { url: 'https://search.gitee.com/?q=', type: 'gitee' },
    { url: 'https://zh.wikipedia.org/w/index.php?search=', type: 'wikipedia' },
    { url: 'https://weixin.sogou.com/weixin?type=2&query=', type: 'wechat' },
    { url: 'https://zzk.cnblogs.com/s/blogpost?w=', type: 'cnblogs' },
